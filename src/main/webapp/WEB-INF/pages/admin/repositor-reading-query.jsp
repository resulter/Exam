...
<div class="btn ue-clear">
	<a href="${ctx}/mock/toRepositoryReading.action" class="confirm" onclick="addQuestion()">返回</a>
</div>
<div class="main">
					...
					<div class="row" id="content-one">
						<div class="col-md-6" id="content-one-left">
							<div   style="text-align: center;">
								<h2>${readingSubject[0].passageTitle}</h2>
							</div>
							${readingSubject[0].passage}
						</div>
						<div class="col-md-6" id="content-one-right">
							<c:forEach items="${readingSubject[0].questionReadingVos}" var="ques">
								<p>${ques.orderNum}.${ques.question}</p>
								<c:forEach items="${ques.optionReadingVos}" var="opt">
				...
				<li class="item">
					<div class="row" id="content-two">
						<div class="col-md-6" id="content-two-left">
							<div   style="text-align: center;">
								<h2>${readingSubject[1].passageTitle}</h2>
							</div>
							${readingSubject[1].passage}
						</div>
						<div class="col-md-6" id="content-two-right">
							<c:forEach items="${readingSubject[1].questionReadingVos}" var="ques">
								<p>${ques.orderNum}.${ques.question}</p>
								<c:forEach items="${ques.optionReadingVos}" var="opt">
									<p style="margin-left: 15px"> ${opt.itemCode}.${opt.itemName}</p>
								</c:forEach>
